...
print(f"¡Solución encontrada! Nonce: {nonce}, Hash: {hash_resultado}")""",
    "steps": [
        ...
        },
        {
            ...
            "state": {"globals": {"dificultad": 4, "nonce": 0}}
        },
        {
            "highlight": {"line": 4},
            ...
            "state": {"globals": {"dificultad": 4, "nonce": 0, "hash_resultado": ""}}
        },
        {
            "highlight": {"line": 5},
            "what": "Se incrementa el 'nonce' en uno para probar un nuevo número (Ej: Intento 1).",
            ...
            "state": {"globals": {"dificultad": 4, "nonce": 1, "hash_resultado": ""}}
        },
        {
            "highlight": {"line": 8},
            "what": "Se simula el cálculo del hash para el nonce actual (Ej: Nonce 1 -> '123'). No cumple la condición.",
            "why": "El resultado es incorrecto. El bucle debe continuar. El minero no tiene más opción que seguir probando.",
            "appData": "Evaluación de una condición dentro de un bucle que resulta en 'falso', provocando la siguiente iteración.",
            "appLaw": "Cada intento fallido es un coste hundido para el minero, pero necesario para el proceso. Es la prueba del esfuerzo continuo.",
            "state": {"globals": {"dificultad": 4, "nonce": 1, "hash_resultado": "123"}, "io": {"log":["Intento con nonce 1: hash '123' (falla)"]}}
        },
        {
            "highlight": {"line": 5},
            "what": "Se vuelve a incrementar el 'nonce' (Ej: Intento 8500).",
            "why": "El proceso se repite miles de veces. La perseverancia es la única estrategia.",
            "appData": "Muestra la naturaleza repetitiva y de fuerza bruta de ciertos algoritmos de búsqueda.",
            "appLaw": "La gran cantidad de intentos demuestra la dificultad real del proceso y justifica el alto consumo energético asociado.",
            "state": {"globals": {"dificultad": 4, "nonce": 8500, "hash_resultado": "123"}}
        },
        {
            "highlight": {"line": 9},
            "what": "¡Eureka! En nuestro intento 8500, simulamos que hemos encontrado la solución.",
            "why": "Simulamos el momento de éxito. El hash generado finalmente cumple la condición de empezar con cuatro ceros. En la realidad, esto es un evento puramente aleatorio.",
            ...
            "state": {"globals": {"dificultad": 4, "nonce": 8500, "hash_resultado": "0000_solucion_encontrada"}, "io": {"log":["Intento con nonce 8500: hash '0000...' (éxito)"]}}
        },
        {
            "highlight": {"line": 12},
            ...
            "state": {"io": {"out": ["¡Solución encontrada! Nonce: 8500, Hash: 0000_solucion_encontrada"]}}
        }
    ]
}
